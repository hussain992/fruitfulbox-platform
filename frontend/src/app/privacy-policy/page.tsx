    ...
    <main className="min-h-screen bg-[var(--color-background)]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-foreground)] mb-4">Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-foreground)] mb-4">Information Collection and Use</h2>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-[var(--color-foreground)] mb-2">Personal Data</h3>
                <p className="text-[var(--color-muted-foreground)] leading-relaxed">
                ...
                <ul className="mt-2 space-y-2 ml-4 text-[var(--color-muted-foreground)]">
                  <li>• Name</li>
                  <li>• Email address</li>
                  <li>• Phone number</li>
              ...
              <div>
                <h3 className="text-lg font-semibold text-[var(--color-foreground)] mb-2">Usage Data</h3>
                <p className="text-[var(--color-muted-foreground)] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-foreground)] mb-4">Use of Data</h2>
            <p className="text-[var(--color-muted-foreground)] leading-relaxed mb-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-foreground)] mb-4">Security of Data</h2>
            <p className="text-[var(--color-muted-foreground)] leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[var(--color-foreground)] mb-4">Contact Us</h2>
            <p className="text-[var(--color-muted-foreground)] leading-relaxed mb-4">
