...
export default function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[linear-gradient(180deg,_#3a2406_0%,_#241405_100%)] text-[#f7e9c4]">
      <div className="absolute inset-0 opacity-10 hidden md:block [background-image:radial-gradient(#fbbf24_1px,transparent_1px)] [background-size:26px_26px]" />
      <div className="absolute -left-12 top-10 h-40 w-40 rounded-full bg-orange-500/20 blur-3xl hidden md:block" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 py-6 md:py-12">
        <div className="mb-6 md:mb-10 rounded-xl md:rounded-[2rem] border border-amber-300/20 bg-white/5 p-3 md:p-6 shadow-[0_18px_50px_rgba(0,0,0,0.18)] backdrop-blur">
          <div className="grid gap-3 md:gap-6 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            ...
            <div className="grid gap-2 md:gap-3 grid-cols-2 md:grid-cols-2">
              <div className="rounded-lg md:rounded-3xl border border-amber-300/20 bg-[#fff3cf]/10 p-2 md:p-4">
                <Clock3 className="h-4 md:h-5 w-auto text-amber-300" />
                <p className="mt-1 md:mt-3 text-xs uppercase tracking-[0.18em] text-amber-100/80">Days</p>
                <p className="mt-0.5 md:mt-1 text-sm md:text-lg font-bold text-white">Sun & Wed</p>
              </div>
              <div className="rounded-lg md:rounded-3xl border border-amber-300/20 bg-[#fff3cf]/10 p-2 md:p-4">
                <MapPin className="h-4 md:h-5 w-auto text-amber-300" />
                <p className="mt-1 md:mt-3 text-xs uppercase tracking-[0.18em] text-amber-100/80">Area</p>
                <p className="mt-0.5 md:mt-1 text-sm md:text-lg font-bold text-white">Pune</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8 md:grid-cols-4">
          <div>
            <h3 className="text-lg md:text-xl font-black text-white">Fruitful Box</h3>
            <p className="mt-2 md:mt-3 text-xs md:text-sm leading-5 md:leading-7 text-[#f4ddb0]">
            ...
            <div className="mt-3 md:mt-6 flex space-x-3">
              <a
          ...
          <div className="hidden md:block">
            <h4 className="mb-3 md:mb-4 text-xs md:text-sm font-semibold uppercase tracking-[0.18em] text-amber-200">Shop</h4>
          ...
          <div className="hidden md:block">
            <h4 className="mb-3 md:mb-4 text-xs md:text-sm font-semibold uppercase tracking-[0.18em] text-amber-200">Information</h4>
            <ul className="space-y-2 md:space-y-3 text-xs md:text-sm">
              <li>
          ...
          <div className="hidden md:block">
            <h4 className="mb-3 md:mb-4 text-xs md:text-sm font-semibold uppercase tracking-[0.18em] text-amber-200">Delivery</h4>
